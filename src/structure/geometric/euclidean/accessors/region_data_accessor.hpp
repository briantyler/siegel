...
/**
 *  @file     region_data_accessor.hpp
 *  @brief    An inline header file for the \c region_data_accessor class.
 *  @note     The \c region_data_accessor class creates a common interface to
...
#ifndef _SG_REGION_DATA_ACCESSOR_H
#define _SG_REGION_DATA_ACCESSOR_H 1

// Global includes
#include <boost/operators.hpp>

// Local includes
#include "structure/geometric/euclidean/detail/region_data.hpp"
...
template <class _Float = double, class _Integer = long>
    class region_data_accessor
  : private boost::equality_comparable< region_data_accessor<_Float,_Integer>
              , boost::equality_comparable<
                                    region_data_accessor<_Float,_Integer>,
                                    detail::region_data<_Float,_Integer>
                >
            >
{
  public:
    //! Object's type
    typedef region_data_accessor<_Float,_Integer> self_type;
    //! Type of a coordinate of zeta
    typedef detail::region_data<_Float,_Integer> zeta_type;
    //! Type of the real component of zeta
    typedef typename zeta_type::interval_data_type real_type;
    //! Type of the imaginary component of zeta
    typedef typename zeta_type::interval_data_type imag_type;
     ...
     */
    region_data_accessor( const zeta_type& __zeta ) : zeta_( __zeta ) { }
