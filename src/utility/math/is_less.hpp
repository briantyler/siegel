 ...
 *  @note     Safe floating point less than comparison
 *  @author   Brian Tyler
 *  @version  1.0
 *  @date     2008-03-17
 */
...
#ifndef _SG_IS_LESS_H
#define _SG_IS_LESS_H 1
...
/**
 *  @class    is_less
 *  @brief    A less than functor for floating point types
 *  @author   Brian Tyler
 *  @version  1.0
 *  @date     2008-03-17
 *  @param    Type The floating point type to compare.
 */
template <class _Type> struct is_less
  : public std::binary_function<typename boost::call_traits<_Type>::param_type,
                                typename boost::call_traits<_Type>::param_type,
                                bool>
{
  //! Object type
  typedef is_less<_Type> self_type;
  //! The value type
  typedef _Type value_type;
  
  
  /**
   *  @brief  Determine if one floating point value is strictly less than
  ...
  {
    typedef is_equal<value_type> __iss;
